        ...
        switch (mShape) {
            case SHAPE_TRIANGLE:
                ...
                if (mIsLoading) {
                    ...
                    int color= ((Integer) mArgbEvaluator.evaluate(mAnimPercent,mTriangleColor,mCircleColor)).intValue();//*******************************
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    int color= ((Integer) mArgbEvaluator.evaluate(mAnimPercent,mCircleColor,mRectColor)).intValue();//*******************************
                    mPaint.setColor(color);
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    int color= ((Integer) mArgbEvaluator.evaluate(mAnimPercent,mRectColor,mTriangleColor)).intValue();//*********************
                    mPaint.setColor(color);
                    Path path = new Path();
